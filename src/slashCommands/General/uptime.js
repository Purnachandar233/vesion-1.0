...
const legacy = require('../../commands/general/uptime.js');

module.exports = {
  name: 'uptime',
  description: legacy.description || 'Converted slash for uptime',
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      client.logger?.log('Converted slash uptime error: ' + (err && (err.stack || err.toString())), 'error');
